...
test_name = 'khorne_9_18_observation'
folder_path = 'W:/FHL_FLUME/khorne/'
external_hard_drive_path = 'E:/FHL_Flume/khorne/'
...
try:
    ...
    try:
        ...
        text_file.write('trial 01' + '\n')
        text_file.write(str(r_list) + '\n')
