# -*- coding: utf-8 -*-
"""
Created on Sat Aug 29 18:11:22 2020
...
test_name = 'slaanesh_day_time_observation'
...
if compress_raw_images == True:
    ...
    try:
        ...
        camera_0_timelapse_ings = glob.glob(path_camera_0_timelapse + '*.' + image_codec)
        ...
        print()
        print('compressing timelapse camera_0 images')
        text_file.write('\n')
        text_file.write('compressing timelapse camera_0 images' + '\n')
        
        for raw_img in camera_0_timelapse_ings:
